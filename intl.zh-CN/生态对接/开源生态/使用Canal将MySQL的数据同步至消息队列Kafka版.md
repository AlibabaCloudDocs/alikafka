...
2.  登录[消息队列Kafka版控制台](https://kafka.console.aliyun.com/?spm=a2c4g.11186623.2.22.6bf72638IfKzDm)，查询消息，确认MySQL的数据被同步在消息队列Kafka版。控制台查询消息的具体操作，请参见[查询消息](/intl.zh-CN/控制台使用指南/查询消息.md)。
