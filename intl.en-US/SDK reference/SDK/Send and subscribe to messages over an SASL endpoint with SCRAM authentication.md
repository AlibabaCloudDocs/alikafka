...
# Send and subscribe to messages over an SASL endpoint with SCRAM authentication

This topic describes how a Java client connects to Message Queue for Apache Kafka over an SASL endpoint in a virtual private cloud \(VPC\) and uses the SCRAM mechanism to send and subscribe to messages.
