...
1.  Create a message sender named KafkaProducerDemo.java.
    ...
    public class KafkaProducerDemo {
        ...
        public static void main(String args[]) {
            ...
            // Set the method for serializing messages of Message Queue for Apache Kafka.
            props.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, "org.apache.kafka.common.serialization.StringSerializer");
            props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, "org.apache.kafka.common.serialization.StringSerializer");
            // Set the maximum waiting time for a request.
            ...
            // Construct a message of Message Queue for Apache Kafka.
            String topic = kafkaProperties.getProperty("topic"); // The topic of the message. Enter the topic that you create in the Message Queue for Apache Kafka console.
            String value = "this is the message's value"; // The content of the message.
    
            try {
                // You can speed up the process by obtaining Future objects in batches. We recommend that you do not obtain excessive Future objects at a time.
...
1.  Subscribe to messages by using any one of the following methods:
        ...
        1.  Create a single-consumer subscription program named KafkaConsumerDemo.java.
            ...
            public class KafkaConsumerDemo {
                ...
                public static void main(String args[]) {
                    ...
                    // If the consumer does not return any heartbeat message within the interval, the broker determines that the consumer is not alive. Then, the broker removes the consumer from the consumer group and triggers rebalance. The default value is 30 seconds.
                    props.put(ConsumerConfig.SESSION_TIMEOUT_MS_CONFIG, 30000);
                    // The maximum number of messages that can be polled at a time.
                    // Do not set the number to an excessively large value. If excessive messages are polled but fail to be all consumed before the next polling cycle starts, load balancing is triggered, which causes freezing.
                    props.put(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, 30);
                    // Specify the method for deserializing messages.
                    props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, "org.apache.kafka.common.serialization.StringDeserializer");
                    props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "org.apache.kafka.common.serialization.StringDeserializer");
                    // The consumer group of the current consumer instance. Enter the consumer group that you create in the Message Queue for Apache Kafka console.
                    ...
                    // You must create the topics in the Message Queue for Apache Kafka console before you add the topics here.
                    ...
                    while (true){
                        try {
                            ...
                            // The messages must be all consumed before the next polling cycle starts. The total duration cannot exceed the timeout interval specified by SESSION_TIMEOUT_MS_CONFIG.
    ...
    -   Multiple consumers subscribe to messages
        1.  Create a multi-consumer subscription program named KafkaMultiConsumerDemo.java.
             ...
             * Ensure that the number of global consumers does not exceed the total number of partitions of the topic that the consumers subscribed to.
             */
