---
keyword: [java, vpc, kafka, send and subscribe to messages, plain]
---

# Send and subscribe to messages over an SASL endpoint with PLAIN authentication

This topic describes how a Java client connects to Message Queue for Apache Kafka over an Simple Authentication and Security Layer \(SASL\) endpoint in a virtual private cloud \(VPC\) and send and subscribe to messages with PLAIN authentication.
...
2.  Create a JAAS configuration file named kafka\_client\_jaas\_plain.conf.
...
4.  Create a profile loader named JavaKafkaConfigurer.java.
